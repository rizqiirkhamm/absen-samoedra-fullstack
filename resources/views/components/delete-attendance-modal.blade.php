<div id="deleteAttendanceModal"
    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform transition-all duration-300 ease-out scale-95 opacity-0"
        id="deleteAttendanceModalContent">
        <div class="p-6">
            ...
            <p class="text-base text-gray-600 mb-6">Apakah Anda yakin ingin menghapus presensi <span
                    id="deleteAttendanceName" class="font-medium"></span>?</p>
            <form id="deleteAttendanceForm" method="POST">
                @csrf
                @method('DELETE')
                <input type="hidden" id="deleteAttendanceId">
                <div class="flex justify-end space-x-3">
                    <button type="button" id="cancelDeleteAttendanceBtn"
